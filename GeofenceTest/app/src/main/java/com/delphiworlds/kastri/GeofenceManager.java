...
public class GeofenceManager implements OnCompleteListener<Void> {
    ...
    private ArrayList<Geofence> getGeofences() {
        ...
        for (Map.Entry<String, GeofenceRegions.Region> entry : mRegions.getItems().entrySet()) {
            ...
            geofences.add(new Geofence.Builder()
                    ...
                    // Create the geofence.
                    .build());
            Log.d(TAG, "> ID " + entry.getKey() + " - Lat: " + Double.toString(region.getCoords().latitude) + ", Long: "
                    + Double.toString(region.getCoords().longitude) + ", Radius: " + Double.toString(region.getRadius()));
        }
        return geofences;
    }
    ...
    public GeofenceManager(Context context, GeofenceManagerDelegate delegate) {
        ...
        Log.d(TAG, "Created pending intent for GeofenceIntentReceiver");
    }
    ...
    public void onComplete(@NonNull Task<Void> task) {
        ...
        if (!success) {
            ...
            Log.d(TAG, "onComplete task type: " + Integer.toString(mPendingGeofenceTask) + " successful");
    ...
    public void setBroadcastTransitionTypes(int value) {
        setIntProperty("BroadcastTransitionTypes", value);
    }
    ...
    public void setNotificationTransitionTypes(int value) {
        setIntProperty("NotificationTransitionTypes", value);
    }
